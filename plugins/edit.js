...
module.exports = {
    ...
    category: 'tools',
    usage: '.edit [اسم|وصف|منشن|رسالة|رياكت|صورة|صوت|استيكر] [شغل|طفي]',
...
.edit استيكر ← لحفظ استيكر (رد على استيكر)
            ...
            switch (type) {
                ...
                case 'استيكر':
                    ...
                    if (stickerMessage) {
                        ...
                        const stickerFile = join(stickerDir, 'STICKER.webp');
                        fs.writeFileSync(stickerFile, buffer);

                        zarfData.sticker = zarfData.sticker || {};
                        zarfData.sticker.file = 'stickers/STICKER.webp';
